...
export default function MainPage() {
    ...
    const matchCountColumnDefs = [
      ...
      { field: 'Investor', width: 105 },
      { field: 'Product', width: 105 },
      { field: 'Career', width: 100 },
      { field: 'News', width: 100 },
      { field: 'ECommerce', width: 130 },
      { field: 'Resources', width: 120 },
      { field: 'Pricing', width: 105 },
      { field: 'Social', width: 100 },
      { field: 'Portal', width: 100 },
      { field: 'Legal', width: 100 },
      { field: 'Blog', width: 100 },
    ];
        ...
        <div id='afterSubmitDiv'>
          {submitClicked ? (
            ...
            <div className='mycontainer'>
              <div className='top'>
                <div className="ag-theme-balham" style={{  textAlign: 'center',width: '100%', height: 70 }}>
